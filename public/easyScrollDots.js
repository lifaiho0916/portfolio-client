...
function scrollIndiClicked(indiId) {
    document.getElementsByClassName("scroll-container")[0].style.height='3000px';
    console.log(document.getElementsByClassName("scroll-container")[0].style);
    ...
    setTimeout(setScrollContainerHeight,1000);
};

function setScrollContainerHeight() {
    document.getElementsByClassName("scroll-container")[0].style.height='100vh';
}